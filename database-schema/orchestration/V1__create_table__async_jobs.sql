...
create index if not exists async_jobs_retain_until_index
    on orchestration.async_jobs (retain_until);

comment on index orchestration.async_jobs_retain_until_index is 'Для отбора записей к удалению';
